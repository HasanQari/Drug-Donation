...
if ($_SESSION) {
    if ($_SESSION['name'] == "admin") {
        ...
        <head>
            ...
            <title> Manager  | خيرات الدواء</title>
        ...
        <body>
            ...
            <nav class="navbar navbar-dark bg-primary pt-2 pb-2" style="padding: 10px 30px 10px 30px;">
                <div class="container-fluid">
                    ...
                    <div class="d-flex">
                        <a href="" 
                            style="text-align:center;color:white;font-weight:bold; text-decoration: none; margin: auto 20px;">التواصل مع الموظفين</a>
                    ...
                    <section id="goal" class="about">
                        <div class="container" data-aos="">
                            <div class="section-title">
                                <h4 style="font-family: GESbold;">لوحة التحكم الخاصة بالادارة</h4>
                            ...
                            <div class="section-body">
                                <h2 style="font-family: GESbold;text-align:center;color:red">الصفحة تحت الصيانة</h2>
                                <p style="font-family: GESbold;text-align:center">نعتذر عن الإزعاج ونسعد بخدمتكم</p>
                            </div>
                        </div>
                    </section>
                </main>
